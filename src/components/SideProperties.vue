  ...
  export default {
    ...
    computed: {
      ...
      showText () {
        ...
        const allowed = ['button', 'dropdown', 'input', 'heading', 'label','table', 'date','browser']
      ...
      showColor () {
        ...
        const allowed = ['heading', 'label', 'hr','table','date','input']
      ...
      showBgColor () {
        ...
        const allowed = ['button', 'label', 'input', 'date','table','image', 'shape', 'browser', 'mobile']
